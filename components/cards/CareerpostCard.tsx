    ...
    return (
        ...
        >
            <div className='flex items-start justify-between'>
                    ...
                    <div className='flex w-full flex-col'>
                        ...
                        <div className={`${isComment && "mb-10"} mt-5 flex flex-col gap-3`}>
                            {/* <div className='flex w-full gap-3.5'>
                                ...
                                <LikeButton careerpostId={id.toString()} currentUserId={currentUserId} isLiked={isLiked == true} />
                                    
                                <Link href={`/careerpost/${id}`} className="font-bold py-2 px-4 border-2 border-black rounded flex items-center gap-2 w-1/2 justify-center">
                ...
                <DeleteCareerpost
                    careerpostId={JSON.stringify(id)}
            ...
            {isComment && comments.length > 0 && (
                <Link href={`/careerpost/${id}`} className="ml-1 mt-6">
                    <p className='mt-1 text-subtle-medium text-gray-1'>
                        {comments.length} repl{comments.length > 1 ? "ies" : "y"}
                    </p>
                </Link>
